...
import (
	"context"
	internalinterfaces "github.com/FFFFFaraway/MPI-Operator/client/informers/externalversions/internalinterfaces"
	time "time"

	batchtestbdapcomv1 "github.com/FFFFFaraway/MPI-Operator/api/batch.test.bdap.com/v1"
	versioned "github.com/FFFFFaraway/MPI-Operator/client/clientset/versioned"
	v1 "github.com/FFFFFaraway/MPI-Operator/client/listers/batch.test.bdap.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.BatchV1().MPIJobs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BatchV1().MPIJobs(namespace).Watch(context.TODO(), options)
			},
		},
		&batchtestbdapcomv1.MPIJob{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *mPIJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&batchtestbdapcomv1.MPIJob{}, f.defaultInformer)
}
