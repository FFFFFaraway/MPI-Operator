...
// BatchV1Client is used to interact with features provided by the batch.test.bdap.com group.
type BatchV1Client struct {
	restClient rest.Interface
}

func (c *BatchV1Client) MPIJobs(namespace string) MPIJobInterface {
